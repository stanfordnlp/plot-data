...
def parse_args():
    ...
    parser.add_argument('--data-out', type=str, default='speaker.f.jsonl')
    parser.add_argument('--status-out', type=str, default='speaker.status.json')
    parser.add_argument('--agg-out', type=str, default='speaker.aggregate.json')
